...
parser.add_argument("--pre_pt", default='/mnt/gemlab_data/User_database/longnuoer/MMVARC/post_model/text_embed_none/stage2', help="Load the trained model, Default: path or None")
parser.add_argument("--save_pt", default='/mnt/gemlab_data/User_database/longnuoer/MMVARC/post_model/text_embed_none/stage3', help="The address where the model is stored after training is completed, Default: path or None")
...
torch.save(post_model.state_dict(), opt.save_pt)